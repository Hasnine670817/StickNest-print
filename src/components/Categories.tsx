      ...
      <div className="max-w-[1100px] mx-auto px-4">
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:flex lg:flex-wrap justify-center gap-x-8 lg:gap-x-0 gap-y-8">
          {[
            ...
            <Link key={cat.name} to={cat.path} className="flex flex-col items-center cursor-pointer group py-6 px-6 rounded-2xl hover:bg-[#E8E8E8] transition-all duration-300">
